    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <a href="/dashboard/new" className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 hover:bg-gray-50 dark:hover:bg-gray-900 transition-colors">
            <h3 className="text-md font-medium mb-1">新規音声作成</h3>
            <p className="text-sm text-gray-500">テキストやURLから音声コンテンツを生成します。</p>
          </a>
          <a href="/dashboard/new?type=video" className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 hover:bg-gray-50 dark:hover:bg-gray-900 transition-colors">
